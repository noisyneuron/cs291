...
function createBody() {
	...
	cylinder = new THREE.Mesh( new THREE.CylinderGeometry(12, 12, 390, 32), 
		cylinderMaterial);
...
function createHead() {
	...
	sphere = new THREE.Mesh( new THREE.SphereGeometry(52, 32, 16), sphereMaterial);
	sphere.position.x = 0;
	sphere.position.y = 390 + 160;
	sphere.position.z = 0;
	scene.add(sphere);

	cylinder = new THREE.Mesh( new THREE.CylinderGeometry(71, 71, 10, 32), cylinderMaterial);
	cylinder.position.x = 0;
	cylinder.position.y = 390 + 160 + 40 + 10/2;
	cylinder.position.z = 0;
	scene.add(cylinder);

	cylinder = new THREE.Mesh( new THREE.CylinderGeometry(40, 40, 70, 32), cylinderMaterial);
	cylinder.position.x = 0;
	cylinder.position.y = 390 + 160 + 40 + 10 + 70/2;
	cylinder.position.z = 0;
	scene.add(cylinder);
